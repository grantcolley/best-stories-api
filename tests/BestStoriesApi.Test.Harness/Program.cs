using BestStoriesApi.Test.Harness;
...
Console.WriteLine("################################");
Console.WriteLine("BestStoriesApi.Test.Harness");
Console.WriteLine("################################");
Console.WriteLine("");
Console.WriteLine("");
...
static async Task<TestStoryContext> GetBestStoriesAsync(HttpClient httpClient, int count)
{
    ...
    try
    {
        ...
        testStoryContext.Stories = await JsonSerializer.DeserializeAsync<IEnumerable<TestStory>>(
